 ...
 *                     2.在需要事务管理的service方法中加入注解自动提交@Transactional(readOnly=false,propagation=Propagation.REQUIRED,isolation= Isolation.REPEATABLE_READ,rollbackFor = Exception.class)
