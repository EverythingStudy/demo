...
public class HttpPostEmulator {
	 ...
	 * @return
	 * @throws Exception
	 * @time 2017-5-8 下午5:34:18
	 * @version
	 */
	public String sendHttpPostRequest(String serverUrl, String jsonString, ArrayList<UploadFileItem> filesToBeUploaded) throws Exception {
